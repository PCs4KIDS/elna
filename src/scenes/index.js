...
gameScene.create = function () {
    ...
    this.sampleText = this.add.text(this.sys.game.config.width / 2, this.sys.game.config.height / 2, 'Some text contained within a game without purpose or reason but just created for the sake of it', {
        fontFamily: 'Gaegu',
        fontSize: '32px',
        wordWrap: true,
        wordWrapWidth: 300
    });
    this.sampleText.x += this.sampleText.width * -.5;
    this.sampleText.y += this.sampleText.height * -.5;
